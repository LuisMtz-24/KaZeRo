...
public class MySQLConnection {
    ...
    private static final String PORT = "52463"; // puerto por defecto de MySQL
    private static final String DATABASE = "kazero_db";
    private static final String USER = "root"; // usuario de Railway
    private static final String PASSWORD = "TjaZprBUqjXhNXihYezGiNZyRywSIGKS"; // contraseña de Railway
